        ...
        <footer className="footer place-items-center sm:place-items-end sm:pe-20 p-4 text-base-content bottom-0 relative" id='footer'>
            <aside className='flex items-center pe-10 md:pe-0'>
                <div className="border-r-2">
                    <a href="https://api.whatsapp.com/send?phone=5491151349215" target='_blank' className='flex flex-wrap justify-center  hover:drop-shadow-dkMode pe-2'> <FontAwesomeIcon icon={faWhatsapp} size='lg' /> contacto </a>
                </div>
